...
PYBIND11_MODULE(spinners, m) {
    ...
    m.def("get_spinner", &spinners::getSpinner, 
          "Get spinner symbols by name",
          py::arg("key"));
    ...
    py::class_<spinners::Spinner>(m, "Spinner")
        ...
        .def(py::init<int, const std::string&, const std::string&, const std::string&>(), 
            py::arg("interval"), py::arg("text"), py::arg("symbols"), py::arg("color"))
        .def("set_color", &spinners::Spinner::setColor, 
             "Set the spinner color", 
             py::arg("color_name"))
        .def("set_interval", &spinners::Spinner::setInterval, 
             "Set the spinner interval in milliseconds", 
             py::arg("interval"))
        .def("set_text", &spinners::Spinner::setText, 
             "Set the text displayed with the spinner", 
             py::arg("text"))
        .def("set_symbols", &spinners::Spinner::setSymbols, 
             "Set the spinner symbols",
             py::arg("symbols"))
